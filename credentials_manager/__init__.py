...
class CredentialsManager(object):
    ...
    def load(self):
        ...
        try:
            ...
            print "Config '%s' file does not exist, creating.." % self.filename
            return self.create()
        else:
            fp.close()
    ...
    def create(self):
        self.username = raw_input("Please enter a username: ")
    ...
    def purge(self):
        if os.path.exists(self._file_path):
            print "Purging old config file: %s" % self._file_path
